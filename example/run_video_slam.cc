...
void printKeyframeLandmarks(std::vector<std::shared_ptr<stella_vslam::data::keyframe>> const& keyfrms,
   ...
   for (auto const& keyfrm : keyfrms) {
        if (!keyfrm)
            ...
            spdlog::info("  id {}, frm id {}, timecode {}, vif frm {}, valid landmarks {}, tracked {}, features {}",
                         keyfrm->id_, keyfrm->src_frm_id_, keyfrm->timestamp_, videoFrame,
