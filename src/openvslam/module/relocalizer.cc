...
relocalizer::relocalizer(const double bow_match_lowe_ratio, const double proj_match_lowe_ratio,
    ...
    : min_num_bow_matches_(min_num_bow_matches), min_num_valid_obs_(min_num_valid_obs), use_fixed_seed_(use_fixed_seed),
...
relocalizer::relocalizer(const openvslam_bfx::config_settings& settings)
