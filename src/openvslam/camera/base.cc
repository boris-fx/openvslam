...
setup_type_t base::load_setup_type(const openvslam_bfx::config_settings& settings) {
...
model_type_t base::load_model_type(const openvslam_bfx::config_settings& settings) {
...
color_order_t base::load_color_order(const openvslam_bfx::config_settings& settings) {
