...
public:
    ...
    static setup_type_t load_setup_type(const openvslam_bfx::config_settings& settings);
    ...
    static model_type_t load_model_type(const openvslam_bfx::config_settings& settings);
    ...
    static color_order_t load_color_order(const openvslam_bfx::config_settings& settings);
