...
namespace {
    struct {
        bool operator()(const std::pair<unsigned int, std::shared_ptr<openvslam::data::keyframe>>& a, const std::pair<unsigned int, std::shared_ptr<openvslam::data::keyframe>>& b) {
