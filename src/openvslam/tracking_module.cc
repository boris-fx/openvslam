...
double get_reloc_distance_threshold(const openvslam_bfx::config_settings& settings) {
...
double get_reloc_angle_threshold(const openvslam_bfx::config_settings& settings) {
    spdlog::debug("load maximum angle threshold between given pose and close keyframes");
    return settings.reloc_angle_threshold_;
}

double get_enable_auto_relocalization(const openvslam_bfx::config_settings& settings) {
    return settings.enable_auto_relocalization_;
}

double get_use_robust_matcher_for_relocalization_request(const openvslam_bfx::config_settings& settings) {
