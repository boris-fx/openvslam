...
setup_type_t base::load_setup_type(const stella_vslam_bfx::config_settings& settings) {
    return settings.camera_setup_;
}
...
model_type_t base::load_model_type(const stella_vslam_bfx::config_settings& settings) {
...
color_order_t base::load_color_order(const stella_vslam_bfx::config_settings& settings) {
    return settings.colour_order_;
}
