...
public:
    ...
    //! Constructor
    stereo_rectifier(camera::base* camera, const stella_vslam_bfx::config_settings& settings);
...
private:
    ...
    //! Load model type before rectification
    static camera::model_type_t load_model_type(const stella_vslam_bfx::config_settings& settings);
